													...
													<div class="card-block">
														<form class="form-material"
															...
															<div class="form-group form-default">
																...
																class="form-control" required="required" autocomplete="off" value="${modeloLogin.senha }"> 
																<span class="form-bar"></span>
															...
															<div class="form-group form-default">
																<input type="text" name="nome" id="nome"
																 class="form-control" required="required" value="${modeloLogin.nome }"> 
																<span class="form-bar"></span> 
															...
															<div class="form-group form-default">
																<input type="email" name="email" id="email" class="form-control" 
																 required="required" autocomplete="off" value="${modeloLogin.email }"> 
																<span class="form-bar"></span>
